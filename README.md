...
- [직접 설치하기](#직접-설치하기)
- [구조 및 동작](#구조-및-동작)
- [GitHub 릴리즈](#github-릴리즈)
- [커스터마이징](#커스터마이징)
- [긴급 우회 (--no-verify)](#긴급-우회---no-verify)
- [문서](#문서)
- [파일 목록](#파일-목록)
- [기여하기](#기여하기)
- [라이선스](#라이선스)
...
훅이 잘못 차단하는 경우 아래 옵션으로 일시적으로 우회할 수 있습니다.
...
> ⚠️ 이 옵션은 **모든 보안 검사를 건너뜁니다**. 꼭 필요한 경우에만 사용하고,
> 이후 훅 패턴을 점검하여 오탐 원인을 수정하세요.
